            ...
            <p className='text-red-500 text-center my-2 '>{error}</p>
                ...
                <div className='my-3'>
                    <form onSubmit={handleLogin}>
                        <input type="email" name='email' className='w-full rounded outline-none h-8 px-2 text-black  mt-4 border-b' placeholder='Your Email' required/>
                        <input type="password" name='password' className='w-full rounded outline-none h-8 px-2 text-black  mt-4 border-b' placeholder='Your Password' required/>
                ...
                <p className='text-base text-center text-slate-600 mb-2'>Don't have an account? Please <Link href="/user/register" className='text-red-500 underline'>Register</Link></p>
            </div>
        </div>
    </div>
    );
